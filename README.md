...
### 使用方法
1. 将 [release](https://github.com/whiterasbk/wolframalpha4mirai/releases/tag/fixed) 下的 [wolframalpha4mirai.jar](https://github.com/whiterasbk/wolframalpha4mirai/releases/download/fixed/wolframalpha4mirai.jar) 文件下载并放入 mirai 运行目录下的 `plugins\` 文件夹
